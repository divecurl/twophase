subroutine calcu_DenseFlux_RiemModel_u2ph(nfirst,nlast,ngc)
  ...
  double precision theL, theR, tmp, tmp1, tmp2, weig(2), p_star, u_star, pu_star
...
!     call HLLC_flux_sybn(flux_loc(1:5),0.d0,dR_1d(kL,i),eR_1d(kL,i),pR_1d(kL,i),cR_1d(kL,i),vxR_1d(kL,i),vyR_1d(kL,i),vzR_1d(kL,i),ke_1d(kL,i),dL_1d(kR,i+1),eL_1d(kR,i+1),pL_1d(kR,i+1),cL_1d(kR,i+1),vxL_1d(kR,i+1),vyL_1d(kR,i+1),vzL_1d(kR,i+1),ke_1d(kR,i+1))
     ...
     if(mif_type(i).eq.0) then
        ...
        call RiemBN_flux_u2ph(flux_la(0:5),flux_eu(0:6),theL,dR_1d(kL,i),eR_1d(kL,i),pR_1d(kL,i),cR_1d(kL,i),vxR_1d(kL,i),vyR_1d(kL,i),vzR_1d(kL,i),ke_1d(kL,i),theR,dL_1d(kR,i+1),eL_1d(kR,i+1),pL_1d(kR,i+1),cL_1d(kR,i+1),vxL_1d(kR,i+1),vyL_1d(kR,i+1),vzL_1d(kR,i+1),ke_1d(kR,i+1))
...
!     call HLLC_flux_sybn(flux_loc(1:5),0.d0,dR_1d(kL,i),eR_1d(kL,i),pR_1d(kL,i),cR_1d(kL,i),vxR_1d(kL,i),vyR_1d(kL,i),vzR_1d(kL,i),ke_1d(kL,i),dL_1d(kR,i+1),eL_1d(kR,i+1),pL_1d(kR,i+1),cL_1d(kR,i+1),vxL_1d(kR,i+1),vyL_1d(kR,i+1),vzL_1d(kR,i+1),ke_1d(kR,i+1))
  ...
  do i=nfirst-1,nlast+1
     ...
     tmp1= dd_1d(1,i)*cc_1d(1,i)
     tmp2= dd_1d(2,i)*cc_1d(2,i)

     if(vofL_1d(2,i).lt.vofR_1d(2,i)) then
        u_star = (pp_1d(1,i)-pp_1d(2,i)+tmp1*vx_1d(1,i)+tmp2*vx_1d(2,i))/(tmp1+tmp2)
        p_star = pp_1d(2,i)+tmp2*(u_star-vx_1d(2,i))
        pu_star= p_star*u_star
     else
        u_star = (pp_1d(2,i)-pp_1d(1,i)+tmp2*vx_1d(2,i)+tmp1*vx_1d(1,i))/(tmp1+tmp2)
        p_star = pp_1d(1,i)+tmp1*(u_star-vx_1d(1,i))
        pu_star = p_star*u_star
     end if
     ...
     do m=1,2
        ...
        fluxC(1,m,i) = u_star*tmp
        fluxC(3,m,i) = - p_star*tmp
        fluxC(6,m,i) = - pu_star*tmp
     end do

  end do

end subroutine calcu_DenseFlux_RiemModel_u2ph
